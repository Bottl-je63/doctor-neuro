        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title">
                    ...
                    <p>
                        Comprehensive treatments for mental health disorders, delivered with compassion and expertise
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 col-12">
                ...
                <div class="subscribe-text">
                    ...
                    <p class="">
                        Empowering patients with effective strategies for managing psychiatric challenges, fostering a
            ...
            <div class="col-lg-6 col-12">
                ...
                <div class="subscribe-form">
                    <form action="./admin/subscriber.php" method="get" class="newsletter-inner">
